...
exports.getCategory = exports.deleteCategory = exports.updateReagent = exports.createReagent = void 0;
const client_1 = __importDefault(require("./client"));
const createReagent = (input) => __awaiter(void 0, void 0, void 0, function* () {
    yield client_1.default.reagent.create({
        data: {
            name: input.name,
...
const updateReagent = (id, input) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedUser = yield client_1.default.reagent.update({
        where: { id: +id },
        data: {
            name: input.name,
            company: input.company,
...
const getCategory = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const reagent = yield client_1.default.reagent.findUnique({ where: { id: +id } });
    return reagent;
});
